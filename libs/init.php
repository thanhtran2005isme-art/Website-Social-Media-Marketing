...
require_once realpath($_SERVER["DOCUMENT_ROOT"]) . '/classes/smmpanel.php';
...
$affiliate_config = json_decode($db->site('affiliate_config'),true);
$charging_config = $db->site('charging_card');
$smtp_server_config = $db->site('smtp_server');

$charging_data = $charging_config ? json_decode($charging_config, true) : [];
$smtp_server_data = $smtp_server_config ? json_decode($smtp_server_config, true) : [];
$general_data = getConfig('general');
$telegram_data = getConfig('telegram');
$card_data = getConfig('charging_card');
$date = date('Y/m/d H:i:s', time());

$list_api_stc = [
    'MB' => 'https://api.dichvudark.vip/historyapimbbankv2',
    'BIDV' => 'https://api.dichvudark.vip/historyapibidvv2',
    'VCB' => 'https://api.dichvudark.vip/historyapivcbv2',
    'ICB' => 'https://api.dichvudark.vip/historyapiviettinv2',
    'ACB' => 'https://api.dichvudark.vip/historyapiacbv2',
    'VIETTEL' => 'https://api.dichvudark.vip/historyapiviettelv2',
    'MSB' => 'https://api.dichvudark.vip/historyapimsbv2',
    'VPB' => 'https://api.dichvudark.vip/historyapivpbv2'
];
$languages = [
    ['id' => 1, 'name' => 'English', 'default_status' => true],
    ['id' => 2, 'name' => 'Vietnamese', 'default_status' => false]
];
$config_listbank = [
