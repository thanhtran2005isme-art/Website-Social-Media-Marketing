...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $data_user['role'] == 1) {
    ...
    $chat_id = isset($_POST['chat_id']) ? Anti_xss($_POST['chat_id']) : '';
    $token = isset($_POST['token']) ? Anti_xss($_POST['token']) : '';
    ...
    if (updateConfig('telegram', $telegram_data)) {
            ...
            <div class="col-xxl-12 col-xl-12">
                <div class="card">
                    <div class="card-header py-3 flex-wrap gap-2">
                        <h4 class="card-title mb-0">Cấu hình telegram</h4>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="">
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="chat_id" value="<?= $telegram_data['chat_id'] ?>">
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label class="form-label">TOKEN TELEGRAM</label>
                                    <input type="text" class="form-control" name="token" value="<?= $telegram_data['token'] ?>">
                                </div>
