...
foreach ($content_details as $detail) {
    ...
    $detail['description'] = is_string($detail['description']) ? json_decode($detail['description'], true) ?? [] : [];
    $detail['content'] = ['media' => is_string($detail['media']) ? json_decode($detail['media'], true) ?? [] : []];
...
<div class="content-body">
    <div class="page-titles">
        <ol class="breadcrumb">
            <li>
                <h5 class="bc-title">Chỉnh sửa câu hỏi</h5>
            </li>
            ...
            <li class="breadcrumb-item active"><a href="/admin/contents/faq">Chỉnh sửa câu hỏi</a></li>
        </ol>
    </div>
